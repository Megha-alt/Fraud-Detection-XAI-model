...
For a sample transaction, the system provides:

Fraud probability (in %)

Final classification (Fraud / Legitimate)

Top contributing features with direction of impact
...
# 📌 Conclusion
This project implements an AI-based fraud detection system that accurately identifies fraudulent transactions while ensuring transparency through Explainable AI (XAI). By combining XGBoost with SHAP explanations, the model achieves high performance on imbalanced data and provides clear insights into decision-making. The approach demonstrates that effective fraud detection can be both accurate and explainable.
